    ...
    <div class="body-content">
        ...
        <div class="row">
            ...
            <div class="col-lg-5">
                ...
                <p>There is an EAP File Contained within the documentation, but there is also an HTML file in case you dont have Enterprise Architect. The EAP file maybe be obtained <a href="https://s3-eu-west-1.amazonaws.com/joako-insided/Doc/insided1.EAP"> at AWS S3 </a> and the HTML documentation may be seen <a href="doc/index.htm"> here </a> (beware: do NOT work in Chrome)</p>

                <p><a class="btn btn-default" href="https://s3-eu-west-1.amazonaws.com/joako-insided/Doc/insided1.EAP">Get The EAP From AWS-S3 &raquo;</a></p>
            </div>
            <div class="col-lg-5">
